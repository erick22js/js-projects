...
function validadeSubSector(lines){
	//Extract each vertex
	var vs = []
...
function splitTree(lines, splitter, rastrer){
	...
	*/
	...
	if(best_minSides==0||best_lineSplitter==null){
		...
		var n1 = splitTree(left_lines, subSplitter, rastrer+"_0l");
		var n2 = splitTree(right_lines, subSplitter, rastrer+"_1r");
		if(n1==null&&n2==null){
			return null;
		}
		else if(n1==null){
